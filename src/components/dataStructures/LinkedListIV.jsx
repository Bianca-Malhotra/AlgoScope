    ...
    <div className="flex flex-col gap-6 p-2">
      ...
      {nodes.length > 0 && (
        <div className="flex gap-4 text-xs text-slate-500 font-mono border-t border-slate-800 pt-3">
          <span>📦 data | <span className="text-slate-400">●→</span> next pointer | <span className="text-red-400">null</span> = end of list</span>
        </div>
      )}
    </div>
  )
